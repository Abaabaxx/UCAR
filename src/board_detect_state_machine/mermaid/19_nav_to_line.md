...
stateDiagram-v2
    ...
    NAV_TO_LANE1_WAITING_POINT --> FINAL_HOLD: Event.NAV_DONE_SUCCESS
    ...
    NAV_TO_LANE2_WAITING_POINT --> FINAL_HOLD: Event.NAV_DONE_SUCCESS
    NAV_TO_LANE2_WAITING_POINT --> ERROR: Event.NAV_DONE_FAILURE

    %% --- 流程终点 ---
    ERROR --> [*]
    note right of FINAL_HOLD
        **最终停留状态**
        机器人将停留在此状态,
        标志着整个任务流程结束。
    end note
