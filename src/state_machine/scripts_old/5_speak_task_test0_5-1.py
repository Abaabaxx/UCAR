...
该版本使用了异步通信的方式，但在 ROS1 中异步通信实现较为繁琐，容易出错，且代码结构复杂。
...
class RobotStateMachine(object):
    ...
    def call_voice_service(self):
        ...
        try:
            ...
            voice_client.call_async(self.current_voice_cmd, self.voice_service_callback)
            rospy.loginfo("语音服务请求已发送")
