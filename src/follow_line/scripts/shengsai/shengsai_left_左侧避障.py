    ...
    def main_control_loop(self, timer_event):
        ...
        if self.current_state == AVOIDANCE_MANEUVER:
            ...
            if self.maneuver_step == 0: # 步骤0: 向右平移
                rospy.loginfo_throttle(1.0, "避障步骤0: 向左平移... (%.2f / %.2f m)", distance_moved, AVOIDANCE_STRAFE_OUT_DISTANCE_M)
                ...
                rospy.loginfo_throttle(1.0, "避障步骤2: 向右平移... (%.2f / %.2f m)", distance_moved, AVOIDANCE_STRAFE_IN_DISTANCE_M)
